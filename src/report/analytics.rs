                ...
                if path.is_dir() {
                    ...
                    match count_lines_in_file(&path) {
                        Ok(lines_count) => match lines_count {
                            ...
                            501..=1000 => self.between_1001_and_2000 += 1,
                            1001..=2000 => self.between_1001_and_2000 += 1,
                            2001..=3000 => self.between_1001_and_2000 += 1,
                            3001..=4000 => self.between_1001_and_2000 += 1,
                            4001..=5000 => self.between_1001_and_2000 += 1,
                            5001..=6000 => self.between_1001_and_2000 += 1,
                            6001..=7000 => self.between_1001_and_2000 += 1,
                            7001..=8000 => self.between_1001_and_2000 += 1,
